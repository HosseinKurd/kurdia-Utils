...
public class CalendarTool {
     ...
     * @param date    String
     */
    public CalendarTool(String date) {
        String strY = date.substring(0, date.indexOf("/"));
        String strM = date.substring(date.indexOf("/") + 1, date.lastIndexOf("/"));
        String strD = date.substring(date.lastIndexOf("/") + 1, date.length());
        ...
        setGregorianDate(Integer.parseInt(strY), Integer.parseInt(strM), Integer.parseInt(strD));
    }
     ...
     * @return String
     */
    public String getWeekDayIranian() {
        String weekDayStr[] = {
                "دوشنبه",
                "سه شنبه",
                "چهارشنبه",
    ...
    private void JDNToIranian() {
        JDNToGregorian();
        irYear = gYear - 621;
        IranianCalendar(); // This invocation will updateCode 'leap' and 'march'
