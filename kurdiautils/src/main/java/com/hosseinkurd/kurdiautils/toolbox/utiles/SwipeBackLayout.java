...
public class SwipeBackLayout extends ViewGroup {
    ...
    public static final String TAG = SwipeBackLayout.class.getSimpleName() + "_TAG";
    ...
    public void scrollToFinishActivity() {
        ...
        viewDragHelper.smoothSlideViewTo(child, left, top);
        invalidate();
    }
    ...
    public interface SwipeBackListener {
        ...
        void onAddFragment(AbsSwipeFrg fragment);
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            // Log.d(SwipeBackLayout.TAG, "Listener Defined : " + (swipeBackListener != null));
